...
\begin{figure}[H]
  \centering
  % TODO: Save your figure as figures/result1.png then switch to includegraphics:
  % \includegraphics[width=0.8\textwidth]{figures/result1.png}
  \fbox{\parbox{0.8\textwidth}{\centering \vspace{2cm} [TODO: Add result figure] \vspace{2cm}}}
