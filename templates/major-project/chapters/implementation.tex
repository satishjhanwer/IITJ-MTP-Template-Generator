...
% Example: pseudocode or short code snippet using verbatim
% (Use verbatim for plain code; add \usepackage{listings} to main.tex for syntax highlighting)
\begin{verbatim}
# TODO: Replace with your own pseudocode or code snippet
